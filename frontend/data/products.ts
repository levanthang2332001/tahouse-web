...
export const PRODUCTS: Product[] = [
  {
    ...
    description:
      "Khóa thông minh phân khúc Luxury tích hợp camera chuông hình, nhận diện khuôn mặt FaceID 3D siêu tốc và kết nối App Wifi điều khiển từ xa.",
    shortDescription:
      "Khóa thông minh phân khúc Luxury tích hợp camera chuông hình, nhận diện khuôn mặt FaceID 3D.",
    images: [
      "https://images.unsplash.com/photo-1558002038-1055907df827?q=80&w=1000",
    ...
    specs: {
      "Chất liệu":
        "Hợp kim kẽm hàng không CNC nguyên khối, mặt kính cường lực chịu lực",
      "Chế độ mở khóa":
        "Face ID, Vân tay, Mật mã, Điện thoại, Thẻ từ, Chìa cơ khẩn cấp",
      "Nguồn cấp năng lượng": "Pin sạc Lithium 5000mAh bền bỉ lên đến 12 tháng",
      "Độ dày cửa tương thích":
        "Cửa gỗ, cửa chống cháy có độ dày từ 38mm - 120mm",
    },
    specifications: {
      ...
      lockingMechanism:
        "Thân khóa tự động hoàn toàn bằng Inox 304, tiêu chuẩn cấp độ C",
    },
    technologies: [
      "AI Face Recognition",
      "FPC Swedish Sensor",
    ...
    faq: [
      {
        question:
          "Dung lượng pin sạc Lithium dùng được bao lâu và sạc như thế nào?",
        answer:
          "Khóa sử dụng pin Lithium sạc dung lượng lớn 5000mAh. Với tần suất mở cửa trung bình, pin có thể hoạt động bền bỉ từ 8 đến 12 tháng.",
      },
      {
        question:
          "Công nghệ Face ID 3D có nhận diện được trong bóng tối không?",
        answer:
          "Có, khóa sử dụng camera hồng ngoại quét đa chiều tự động phát hiện và nhận diện khuôn mặt chính xác ngay cả trong môi trường tối.",
      },
    ],
  },
  {
    ...
    description:
      "Bếp từ đa điểm cao cấp nhập khẩu nguyên khối từ Đức. Trang bị mặt bếp Schott Ceran chịu nhiệt, bảng điều khiển DirectSelect Premium và chức năng cảm biến chiên xào thông minh.",
    shortDescription:
      "Bếp từ đa điểm cao cấp nhập khẩu nguyên khối từ Đức, Schott Ceran chịu nhiệt.",
    images: [
      "https://images.unsplash.com/photo-1556911220-e15b29be8c8f?q=80&w=1000",
    ...
    specifications: {
      ...
      openingMethods: [
        "Cảm ứng trượt DirectSelect Premium",
        "Khóa an toàn trẻ em",
      ],
    ...
    faq: [
      {
        ...
        answer:
          "FlexInduction cho phép bạn kết hợp hai vùng nấu nhỏ thành một vùng nấu phẳng cỡ lớn thống nhất.",
      },
    ],
  },
  {
    ...
    description:
      "Chậu rửa bát đá thạch anh cao cấp nhập khẩu chính hãng từ Ý. Chất liệu Keratek kháng khuẩn 99.9%, bền bỉ chống bám bẩn trầy xước.",
    shortDescription:
      "Chậu rửa bát đá thạch anh cao cấp nhập khẩu chính hãng từ Ý, kháng khuẩn 99.9%.",
    images: [
      "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?q=80&w=1000",
      "https://images.unsplash.com/photo-1556911220-e15b29be8c8f?q=80&w=1000",
    ],
    ...
    specs: {
      ...
      "Vật liệu độc quyền":
        "80% Bột đá thạch anh tự nhiên + Keo acrylic cao cấp",
      "Kiểu lắp đặt": "Lắp nổi biên mỏng hoặc lắp âm bàn đá tinh tế",
      "Phụ kiện tặng kèm":
        "Thớt gỗ sồi cao cấp Italy, Siphon ngăn mùi kháng khuẩn",
    },
    specifications: {
      ...
      lockingMechanism:
        "Siphon ngăn mùi kháng khuẩn thông minh tự lưu thông nước thoát",
    },
    technologies: [
      "Keratek Plus Nano Tech",
      "BioShield Antibacterial",
      "Drainage Flow Optimizer",
    ],
    warranty: 60,
    ...
    faq: [
      {
        ...
        answer:
          "Không, Keratek Plus giúp bề mặt chậu rửa cực kỳ mịn màng, chống bám màu và chịu nhiệt cao.",
      },
    ],
  },
  {
    ...
    description:
      "Công nghệ màng lọc RO-Side Stream độc quyền nâng cao tỷ lệ nước tinh khiết thu hồi, thiết kế không bình chứa đặt gọn âm tủ tối giản tinh tế.",
    shortDescription:
      "Công nghệ màng lọc RO-Side Stream độc quyền thu hồi nước cao cấp A.O. Smith.",
    images: [
      "https://images.unsplash.com/photo-1585338107529-13afc5f02586?q=80&w=1000",
    ...
    specifications: {
      ...
      openingMethods: [
        "Vòi điện tử cảm ứng hiển thị chất lượng TDS",
        "Lõi lọc thay nhanh EasyLink",
      ],
    ...
    faq: [
      {
        question:
          "Nước lọc ra từ máy A.O. Smith có cần đun sôi lại trước khi uống không?",
        answer:
          "Không cần đun sôi. Nước qua màng lọc RO đạt chuẩn nước uống trực tiếp tại vòi.",
      },
    ],
  },
  {
    ...
    description:
      "Hệ thống khay inox chống rỉ 304 tích hợp ray giảm chấn thông minh, chuyển động nhẹ nhàng ngay cả khi phân bổ tải trọng lớn.",
    shortDescription:
      "Khay inox chống rỉ 304 tích hợp ray giảm chấn thông minh Hafele.",
    images: [
      "https://images.unsplash.com/photo-1595515106969-1ce29566ff1c?q=80&w=1000",
    ...
    technologies: [
      "Hafele SoftClose Rails",
      "SUS304 Electroplating",
    ...
    faq: [
      {
        ...
        answer:
          "Không. Chất liệu Inox 304 cao cấp có khả năng chống oxy hóa rất cao.",
      },
    ],
  },
  {
    ...
    description:
      "Thiết kế âm tủ thời thượng, kính đen viền thép không gỉ nguyên khối. Hệ thống quạt đối lưu 3D nướng chín đều hoàn hảo.",
    shortDescription:
      "Lò nướng đối lưu thiết kế âm tủ thời thượng kính đen viền thép không gỉ Malloca.",
    images: [
      "https://images.unsplash.com/photo-1590794056226-79ef3a8147e1?q=80&w=1000",
    ...
    technologies: [
      "Hydroclean Self-Clean",
      "3D Convection Fan",
      "SafeTouch Cool Door",
      "SmartControl Touchscreen",
    ],
    warranty: 36,
    ...
    faq: [
      {
        ...
        answer:
          "Hydroclean sử dụng hơi nước để làm mềm dầu mỡ bám trên thành lò.",
      },
    ],
  },
  {
    ...
    description:
      "Khóa cửa gỗ dáng Slim thon gọn sang trọng tinh tế, tay kéo đẩy xoay chuyển mượt mà, chuyên dụng cho căn hộ cao cấp và văn phòng.",
    shortDescription:
      "Khóa cửa gỗ dáng Slim thon gọn tay kéo đẩy xoay chuyển mượt mà TA-8500.",
    images: [
      "https://images.unsplash.com/photo-1507652313519-d4e9174996dd?q=80&w=1000",
      "https://images.unsplash.com/photo-1558002038-1055907df827?q=80&w=1000",
    ],
    ...
    specifications: {
      ...
      openingMethods: [
        ...
        "Mã số ảo",
        "Thẻ từ",
        "Chìa khóa cơ chống đoản",
        "App Wifi Tuya",
      ],
      lockingMechanism:
        "Thân khóa tự động Inox 304 chốt vát nghiêng chống cạy rung lắc",
    },
    technologies: [
      "Push-Pull Ergo",
      "FPC Fingerprint Hub",
    ...
    faq: [
      {
        question:
          "Khi khóa bị hết pin đột ngột mà đang ở ngoài thì làm cách nào?",
        answer:
          "Bạn có thể dùng chìa khóa cơ dự phòng hoặc cắm sạc dự phòng qua cổng USB-C.",
      },
    ],
  },
  {
    ...
    description:
      "Bộ điều khiển trung tâm IoT quản lý toàn bộ thiết bị nhà bếp, khóa thông minh và hệ ánh sáng rèm cửa thông minh toàn diện.",
    shortDescription:
      "Bộ điều khiển trung tâm IoT quản lý toàn bộ thiết bị nhà bếp khóa thông minh TA-Core.",
    images: [
      "https://images.unsplash.com/photo-1558002038-1055907df827?q=80&w=1000",
      "https://images.unsplash.com/photo-1507652313519-d4e9174996dd?q=80&w=1000",
    ],
    ...
    specifications: {
      ...
      material:
        "Khung hợp kim nhôm phay CNC phủ anodized, mặt kính IPS cường lực",
      ...
      lockingMechanism:
        "Hệ thống mã hóa dữ liệu cục bộ an toàn cao, tự động khôi phục ngữ cảnh khi mất mạng",
    },
    technologies: [
      "Zigbee 3.0 Standard",
      "Local Automation Scene",
    ...
    faq: [
      {
        question:
          "Hệ thống có tự động hóa bật tắt các thiết bị bếp và khóa không?",
        answer:
          "Có, TA-Core cho phép thiết lập nhiều kịch bản tự động hóa cho nhà thông minh.",
      },
    ],
  },
  {
    ...
    description:
      "Khóa vân tay chuyên dụng cho cửa kính cường lực văn phòng, showroom, shop thời trang. Thiết kế kẹp kính không cần khoan đục tiện lợi, độ an toàn cao.",
    shortDescription:
      "Khóa vân tay chuyên dụng cho cửa kính cường lực văn phòng, showroom.",
    images: [
      "https://images.unsplash.com/photo-1507652313519-d4e9174996dd?q=80&w=1000",
      "https://images.unsplash.com/photo-1558002038-1055907df827?q=80&w=1000",
    ],
    ...
    specs: {
      "Chất liệu":
        "Hợp kim nhôm cao cấp cường lực chịu lực, mặt kính acrylic chống xước",
      "Chế độ mở khóa":
        "Vân tay, Mật mã, Thẻ từ, App di động, Remote điều khiển",
      "Nguồn cấp năng lượng":
        "4 viên pin AA Alkaline 1.5V hoạt động bền bỉ 10 tháng",
      "Độ dày cửa tương thích":
        "Cửa kính cường lực không khung có độ dày từ 10mm - 12mm",
    },
    specifications: {
    ...
    technologies: [
      "FPC Swedish Bio-Sensor",
      "Double Lock Cylinder",
      "Tuya Mobile IoT",
      "Anti-Peeping PIN Code",
    ],
    warranty: 24,
    warrantyText: "24 Tháng",
    ...
    faq: [
      {
        question:
          "Cửa kính có khung nhôm hoặc khung gỗ thì có lắp được khóa này không?",
        answer:
          "Khóa này thiết kế kẹp chuyên dụng cho kính không khung. Nếu kính có khung, bạn nên chọn dòng khóa nhôm xingfa mỏng.",
      },
    ],
  },
  {
    ...
    description:
      "Dòng khóa thông minh chống nước tuyệt hảo tiêu chuẩn IP65, thân khóa thiết kế siêu mỏng (Slim profile 38mm) chuyên dụng cho các loại cửa nhôm kính Xingfa, cửa sắt hộp ngoài trời.",
    shortDescription:
      "Khóa thông minh chống nước IP65, thân khóa thiết kế siêu mỏng chuyên nhôm xingfa.",
    images: [
      "https://images.unsplash.com/photo-1558002038-1055907df827?q=80&w=1000",
      "https://images.unsplash.com/photo-1507652313519-d4e9174996dd?q=80&w=1000",
    ],
    ...
    specs: {
      "Chất liệu":
        "Hợp kim SUS 304 chống rỉ sét ăn mòn muối biển, mặt kính acrylic",
      "Chế độ mở khóa":
        "Vân tay, Mật mã, Thẻ từ, App Wifi Tuya, Chìa cơ khẩn cấp",
      "Nguồn cấp năng lượng":
        "4 viên pin AAA Alkaline sử dụng lên đến 10 tháng",
      "Độ dày cửa tương thích":
        "Cửa nhôm Xingfa, cửa sắt hộp có đố cửa rộng >= 50mm, dày >= 35mm",
    },
    specifications: {
      ...
      openingMethods: [
        "Vân tay",
        "Mật mã chống nhìn trộm",
        "Thẻ từ thông minh",
        "Chìa cơ",
        "App Wifi Tuya",
      ],
      lockingMechanism:
        "Ruột khóa inox 304 móc đa điểm chuyên dụng cửa lùa hoặc chốt thẳng",
    },
    technologies: [
      "IP65 Waterproof",
      "Slim Body Fit",
    ...
    faq: [
      {
        question:
          "Khóa này có lắp được cho cửa sắt hộp ngoài trời chịu mưa gió trực tiếp không?",
        answer:
          "Được. Với vỏ hợp kim SUS 304 và gioăng cao su chống nước tiêu chuẩn IP65, khóa chịu tốt mưa ẩm.",
      },
    ],
  },
  {
    ...
    description:
      "Khóa cổng thông minh chuyên dụng ngoài trời với hai mặt vân tay độc lập cực kỳ an toàn. Chống nước tuyệt đối IP68 và vỏ hợp kim đúc dày chống chịu va đập mạnh.",
    shortDescription:
      "Khóa cổng vân tay ngoài trời 2 mặt độc lập chống nước IP68.",
    images: [
      "https://images.unsplash.com/photo-1599839619722-39751411ea63?q=80&w=1000",
      "https://images.unsplash.com/photo-1558002038-1055907df827?q=80&w=1000",
    ],
    ...
    specs: {
      "Chất liệu":
        "Hợp kim đúc dày cường lực, ruột khóa Inox 304 siêu chịu lực",
      "Chế độ mở khóa": "Vân tay 2 mặt, Thẻ từ, Chìa cơ khẩn cấp, App di động",
      "Nguồn cấp năng lượng":
        "4 viên pin AA Alkaline hoặc hỗ trợ cấp nguồn điện trực tiếp 12V",
      "Độ dày cửa tương thích":
        "Cửa sắt cổng, cửa cổng inox hộp, cửa sắt nan dày từ 30mm - 80mm",
    },
    specifications: {
      ...
      openingMethods: [
        "Vân tay mặt ngoài + mặt trong",
        "Thẻ từ IC",
        "Chìa khóa cơ chống sao chép",
        "App Tuya",
      ],
      lockingMechanism: "Lưỡi chốt tự động móc xoay bằng Inox đúc dày 20mm",
    },
    technologies: [
      "Dual-Side Bio Fingerprint",
      "IP68 Weatherproof",
    ...
    faq: [
      {
        ...
        answer:
          "Cửa cổng sắt nan thưa người ngoài có thể thọc tay qua khe cửa vào trong gạt chốt. Vân tay 2 mặt bắt buộc phải quét vân tay hợp lệ từ mặt trong mới có thể mở được cửa đi ra.",
      },
    ],
  },
  {
    ...
    description:
      "Giải pháp khóa thẻ từ thông minh chuyên sâu cho khách sạn, homestay, nhà nghỉ và văn phòng. Quản lý phân quyền thẻ từ cực kỳ dễ dàng bằng phần mềm chuyên nghiệp.",
    shortDescription:
      "Khóa thẻ từ khách sạn thông minh, phần mềm quản lý phòng chuyên nghiệp.",
    images: [
      "https://images.unsplash.com/photo-1558002038-1055907df827?q=80&w=1000",
      "https://images.unsplash.com/photo-1507652313519-d4e9174996dd?q=80&w=1000",
    ],
    ...
    specifications: {
      ...
      lockingMechanism:
        "Thân khóa tiêu chuẩn 5 chốt Euro Mortise siêu bền chống cạy",
    },
    technologies: [
      "PVD Coating Finish",
      "RFID Encryption",
      "Euro Standard Mortise",
    ...
    faq: [
      {
        question:
          "Hệ thống thẻ từ có tương thích với các công tắc tiết kiệm điện trong phòng không?",
        answer:
          "Có, thẻ Mifare 13.56Mhz phát ra từ khóa hoàn toàn tương thích với các dòng công tắc thẻ từ tiết kiệm điện hiện nay.",
      },
    ],
  },
];
